...
Version  : 2.4.0
Release  : 39
URL      : https://cran.r-project.org/src/contrib/pmml_2.4.0.tar.gz
Source0  : https://cran.r-project.org/src/contrib/pmml_2.4.0.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1610733248
...
/usr/lib64/R/library/pmml/tests/testthat/pmml-4-4_previous_version.xsd
